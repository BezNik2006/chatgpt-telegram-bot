...
| `MAX_TOKENS`                        | Upper bound on how many tokens the ChatGPT API will return. Note: GPT-5 and O-models use `max_completion_tokens` instead of `max_tokens`.                                                                                                                                                                                                                              | `1200` for GPT-3, `2400` for GPT-4 |
...
| `ENABLE_OPENAI_LOGGING`             | Whether to enable detailed logging of OpenAI API requests and responses                                                                                                                                                                                                                  | `false`                            |
| `OPENAI_LOG_LEVEL`                  | Log level for OpenAI logging. Allowed values: `DEBUG`, `INFO`, `WARNING`, `ERROR`                                                                                                                                                                                                       | `INFO`                             |
